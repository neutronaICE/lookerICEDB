view: quote_opportunities {
  sql_table_name: dbo.QuoteOpportunities ;;
  ...
  dimension: mrcost_sale {
    type: string
    sql: ${TABLE}.MRCostSale ;;
  }
  ...
  dimension: state_working_hours {
    type: number
    sql: ${TABLE}.StateWorkingHours ;;
  }
